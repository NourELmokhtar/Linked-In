...
namespace WebApi_Angular_Proj.Controllers
{
    ...
    public class SharedCommentController : ControllerBase
    {
        IsharedCommentRepositry CommentRepository;
        public SharedCommentController(IsharedCommentRepositry _commentRepository)
        {
